# Contributing to ChilliSource.Mobile.Media #

Your contributions to ChilliSource.Mobile.Media are very welcome. Please grab and fix bugs and feature requests from the list of [issues](https://github.com/BlueChilli/ChilliSource.Mobile.Media/issues).
To report a bug or feature request, please log a new issue [here](https://github.com/BlueChilli/ChilliSource.Mobile.Media/issues/new).
