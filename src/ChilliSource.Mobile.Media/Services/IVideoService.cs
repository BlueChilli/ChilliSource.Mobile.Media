...
namespace ChilliSource.Mobile.Media
{
	...
	public interface IVideoService
	{
		...
		/// <summary>
		/// Concatenates the specified video files and saves the resulting video to the <paramref name="outputFilePath"/>
		/// </summary>
		/// <returns><see cref="T:ChilliSource.Mobile.Core.OperationResult"/> instance indicating the outcome of the operation</returns>
		/// <param name="filePaths">Source video file paths.</param>
		/// <param name="outputFilePath">Output file path.</param>
		/// <param name="quality">Quality.</param>
		/// <param name="exportSizeType">Export size type.</param>
		/// <param name="exportInLandscape">If set to <c>true</c> export in landscape.</param>
		/// <param name="exportAudio">If set to <c>true</c> export audio.</param>
		Task<OperationResult> CombineVideoFiles(List<string> filePaths, string outputFilePath, VideoExportQuality quality,
